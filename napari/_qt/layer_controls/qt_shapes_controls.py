...
class QtShapesControls(QtLayerControls):
    ...
    def __init__(self, layer) -> None:
        ...
        button_grid_layout.addWidget(self.direct_button, 1, 0)
        button_grid_layout.addWidget(self.select_button, 1, 1)
        button_grid_layout.addWidget(self.delete_button, 1, 2)
        button_grid_layout.addWidget(self.vertex_insert_button, 1, 3)
